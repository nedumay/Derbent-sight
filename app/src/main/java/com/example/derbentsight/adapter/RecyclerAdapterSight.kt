...
class RecyclerAdapterSight internal constructor(context: Context?, dataItem: List<DataItem>, private val onClickListener: onRecyclerClickListener):
    RecyclerView.Adapter<RecyclerAdapterSight.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View = inflater.inflate(R.layout.list_item_sight, parent, false)
